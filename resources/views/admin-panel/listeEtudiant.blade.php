...
<div class="card shadow mb-4">
    <div class="card-header py-3">
        <h6 class="m-0 font-weight-bold text-primary text-center" style="font-size: x-large">Liste des étudiants</h6>
    </div>
    <div class="card-body">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td> <a href="afficherEtudiant/{{$item['id']}}" class="btn btn-warning" style=" background-color:blue; color:white">Afficher</a>
                            ...
                            <a href="afficherModifierEtudiant/{{$item['id']}}" class="btn btn-warning" style="color:white">Modifier</a>
                        </td>
