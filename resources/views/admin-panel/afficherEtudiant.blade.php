        ...
        <div class="row" >
            ...
            <div class="col-lg-8 col-md-7">
                <div class="team-single-text padding-50px-left sm-no-padding-left">
                    <h4 class="font-size38 sm-font-size32 xs-font-size30">{{$etudiant['nom']}} {{$etudiant['prenom']}}</h4>
                            ...
                            <li>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-7 col-7">
                                        <p>Ecole Supérieure de Technologie Kénitra</p>
                                    </div>
                                </div>
                            ...
                            <li>
                                ...
                                <div class="row">
                                    <div class="col-md-5 col-5">
                                        ...
                                        <strong class="margin-10px-left text-yellow">Filière:</strong>
                                    </div>
                                    <div class="col-md-7 col-7">
                            ...
                            <li>
                                ...
                                <div class="row">
                                    <div class="col-md-5 col-5">
                                        ...
                                        <strong class="margin-10px-left text-lightred">Date de naissance:</strong>
                                    </div>
                                    <div class="col-md-7 col-7">
