...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
    <h1 class="h3 mb-0 text-gray-900">Modifier étudiant</h1>
</div>
...
<div class="form-group">
    ...
    <div class="col-md-4">
        <input type="text" placeholder="Numero d'etudiant" class="form-control input-md" name="nom_user" value="{{$etudiants['num_etd']}}" />
    </div>
</div>
